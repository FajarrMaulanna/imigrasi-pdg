...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="faq-dash.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        ...
                        <div class="card-body">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#tambah_faq">Tambah</button>
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data_faq = mysqli_query($mysqli, "SELECT * FROM faq");
                                        while($faq = mysqli_fetch_array($data_faq)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $faq['pertanyaan']; ?></td>
                                        <td><?php echo $faq['jawaban']; ?></td>
                                        <td><a class="btn btn-danger" href="hapus_faq.php?id=<?php echo $faq['id']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        }
                                    ?>
    ...
    <!-- Tambah FAQ -->
    <div class="modal fade" id="tambah_faq" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="tambah-faq.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Pertanyaan</label>
                            <textarea type="text" placeholder="Masukkan Pertanyaan" class="form-control" name="tanya_faq" required></textarea>
                        </div>
                        <div class="form-group">
                            <label>Jawaban</label>
                            <textarea type="text" placeholder="Masukkan Jawaban" class="form-control" name="jawab_faq" required></textarea>
                        </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
