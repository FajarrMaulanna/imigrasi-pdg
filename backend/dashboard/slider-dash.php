                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Poster Slider</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><img id="preview-slide" src="../files/slider/<?php echo $slide['file_slide'];?>" alt="..."></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal_slide<?php echo $slide['id_slide']?>">Update</button>|<a class="btn btn-danger" href="hapus-slide.php?id=<?php echo $slide['id_slide']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                            include 'modal-slider.php';
                                        }
                                    ?>
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="tambah-slide.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Masukan File Slider (PNG, JPEG, JPG, GIF)</label>
