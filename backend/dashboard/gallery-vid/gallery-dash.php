...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        ...
                        <div class="card-body">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#tambah_vid">Tambah</button>
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data_vid = mysqli_query($mysqli, "SELECT * FROM gallery_vid");
                                        while($vid = mysqli_fetch_array($data_vid)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><iframe width="250px" height="170px" src="https://www.youtube.com/embed/<?php echo $vid['kode_vid'];?>" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
                                        <td><?php echo $vid['kode_vid'];?></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal_gallery<?php echo $vid['id']?>">Update</button>|<a class="btn btn-danger" href="delete_gallery_vid.php?id=<?php echo $vid['id']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_gallery_vid.php';
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <div class="modal fade" id="tambah_vid" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Video Youtube</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="tambah_gallery_vid.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Masukkan Kode Video" class="form-control" name="kode-vid" required>
                        </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
