...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseProduk" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="undang.php">Undang-Undang</a>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data = mysqli_query($mysqli, "SELECT * FROM undang_undang");
                                        while($d = mysqli_fetch_array($data)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><a href="../../../files/undang-undang/<?php echo $d['file_uu'];?>" target="_blank"><?php echo $d['judul_uu'];?></a></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalproduk<?php echo $d['id'] ?>">Update</button> | <a class="btn btn-danger" href="delete_uu.php?id=<?php echo $d['id'] ?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_up_uu.php'; 
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="tambah_uu.php" method="post" enctype="multipart/form-data">
