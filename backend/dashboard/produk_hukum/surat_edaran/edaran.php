...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseProduk" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="edaran.php">Surat Edaran</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Surat Edaran</h6>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data = mysqli_query($mysqli, "SELECT * FROM sur_edaran");
                                        while($d = mysqli_fetch_array($data)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><a href="../../../files/surat_edaran/<?php echo $d['file_edaran'];?>" target="_blank"><?php echo $d['judul_edaran'];?></a></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalproduk<?php echo $d['id'] ?>">Update</button> | <a class="btn btn-danger" href="delete_edaran.php?id=<?php echo $d['id'] ?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_up_edaran.php'; 
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="tambah_edaran.php" method="post" enctype="multipart/form-data">
