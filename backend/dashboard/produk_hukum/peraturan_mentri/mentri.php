...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseProduk" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="mentri.php">Peraturan Mentri</a>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Peraturan Mentri</h6>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data = mysqli_query($mysqli, "SELECT * FROM per_men");
                                        while($d = mysqli_fetch_array($data)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><a href="../../../files/peraturan_mentri/<?php echo $d['file_permen'];?>" target="_blank"><?php echo $d['judul_permen'];?></a></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalproduk<?php echo $d['id'] ?>">Update</button> | <a class="btn btn-danger" href="delete_permen.php?id=<?php echo $d['id'] ?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_up_permen.php'; 
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Tambah Peraturan Mentri</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <form action="tambah_permen.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Judul Peraturan Mentri</label>
                    <input type="text" class="form-control" name="nama_uu" required>
                </div>
                <div class="form-group">
                    <label>File Peraturan Mentri</label>
