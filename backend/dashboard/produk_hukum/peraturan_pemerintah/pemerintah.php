...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseProduk" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pemerintah.php">Peraturan Pemerintah</a>
                        <a class="collapse-item" href="../peraturan_presiden/presiden.php">Peraturan Presiden</a>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Peraturan Pemerintah</h6>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered dataTable">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Judul Peraturan Pemerintah</th>
                                        <th>Option</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data = mysqli_query($mysqli, "SELECT * FROM per_pemerintah");
                                        while($d = mysqli_fetch_array($data)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><a href="../../../files/peraturan_pemerintah/<?php echo $d['file_perpem'];?>" target="_blank"><?php echo $d['judul_perpem'];?></a></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalproduk<?php echo $d['id'] ?>">Update</button> | <a class="btn btn-danger" href="delete_perpem.php?id=<?php echo $d['id'] ?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_up_perpem.php'; 
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Tambah Peraturan Pemerintah</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <form action="tambah_perpem.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Judul Peraturan Pemerintah</label>
                    <input type="text" class="form-control" name="nama_uu" required>
                </div>
                <div class="form-group">
                    <label>File Peraturan Pemerintah</label>
