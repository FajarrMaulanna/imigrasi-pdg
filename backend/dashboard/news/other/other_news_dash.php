...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="other_news_dash.php">Berita Media Lain</a>
                        <a class="collapse-item" href="../own/own_news_dash.php">Berita Pribadi</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Link Berita Imigrasi dari Media Lain</h6>
                        </div>
                        <div class="card-body">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#tambah_slide">Tambah</button>
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data_news = mysqli_query($mysqli, "SELECT * FROM other_news ORDER BY id DESC");
                                        while($news = mysqli_fetch_array($data_news)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><a href="<?php echo $news['link_med']; ?>" target="_blank"><?php echo $news['judul_med'];?></a></td>
                                        <td><?php echo $news['sekilas_med'];?></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal_news<?php echo $news['id']?>">Update</button>|<a class="btn btn-danger" href="hapus_other_news.php?id=<?php echo $news['id']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_other_news.php';
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <!-- Tambah SLider -->
    <div class="modal fade" id="tambah_slide" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="tambah_news_other.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Judul Berita</label>
                            <input type="text" class="form-control" name="judul_med" placeholder="Masukkan Judul Berita" required>
                        </div>
                        <div class="form-group">
                            <label>Link Berita</label>
                            <input type="text" class="form-control" name="link_med" placeholder="Masukkan Link Berita" required>
                        </div>
                        <div class="form-group">
                            <label>Referensi</label>
                            <input type="text" class="form-control" name="sekilas_med" placeholder="Masukkan Referensi Berita" required></input>
                        </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
