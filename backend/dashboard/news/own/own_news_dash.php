            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../other/other_news_dash.php">Berita Media Lain</a>
                        <a class="collapse-item" href="own_news_dash.php">Berita Pribadi</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Berita Seputar Imigrasi</h6>
                        </div>
                        <div class="card-body" style="overflow-x: scroll;">
                            ...
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data_news = mysqli_query($mysqli, "SELECT * FROM own_news ORDER BY id DESC");
                                        while($news = mysqli_fetch_array($data_news)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $news['header']; ?></td>
                                        <td><?php echo $news['desc_news']; ?></td>
                                        <td><img src="../../../files/own_news/<?php echo $news['img_news']; ?>" alt="" width="150px"></td>
                                        <td><?php echo $news['date_news']; ?></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal_news<?php echo $news['id']?>">Update</button>|<a class="btn btn-danger" href="hapus_own_news.php?id=<?php echo $news['id']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                        include 'modal_own_news.php'; 
                                        }
                                    ?>
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="tambah_news_own.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Judul Berita</label>
                            <input type="text" class="form-control" name="judul_own" placeholder="Masukkan Judul Berita" required>
                        </div>
                        <div class="form-group">
                            <label>Deskripsi Berita</label>
                            <textarea type="text" class="form-control" name="desc_own" placeholder="Masukkan Deskripsi Berita" required></textarea>
                        </div>
                        <div class="form-group">
