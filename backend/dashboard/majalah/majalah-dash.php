    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="majalah-dash.php">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Majalah Imigrasi Rancak</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    <?php
                                        $no = 1;
                                        $data_maj = mysqli_query($mysqli, "SELECT * FROM majalah_imi ORDER BY id_maj DESC");
                                        while($mj = mysqli_fetch_array($data_maj)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><img src="../../files/cover_majalah/<?php echo $mj['cover_maj'] ?>" alt="" width="150px"></td>
                                        <td><a href="../../files/majalah/<?php echo $mj['file_maj'];?>" target="_blank"><?php echo $mj['nama_maj'];?></a></td>
                                        <td><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#modal_maj<?php echo $mj['id_maj']?>">Update</a>|<a class="btn btn-danger" href="hapus_majalah.php?id=<?php echo $mj['id_maj']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                            include 'modal_majalah.php';
                                        }
                                    ?>
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="tambah_majalah.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Edisi</label>
                            <input type="text" class="form-control" name="namamajalah" placeholder="Masukkan Edisi" required>
                        </div>
                        <div class="form-group">
