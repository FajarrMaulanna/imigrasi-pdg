...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Photos</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4" style="overflow-x: scroll;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Foto Homepage</h6>
                        </div>
                        <div class="card-body">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#tambah_foto">Tambah</button>
                            <table class="table table-bordered dataTable">
                                <thead>
                                    <tr>
                                        <th width="10%">No</th>
                                        <th width="30%">Preview Foto</th>
                                        <th>Judul</th>
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $data_foto = mysqli_query($mysqli, "SELECT * FROM foto_home");
                                        while($foto = mysqli_fetch_array($data_foto)){
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><img src="../files/foto_home/<?php echo $foto['file_foto'];?>" alt="..." width="200px"></td>
                                        <td><?php echo $foto['judul_foto'];?></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal_foto<?php echo $foto['id']?>">Update</button>|<a class="btn btn-danger" href="hapus-foto.php?id=<?php echo $foto['id']?>" type="button">Delete</a></td>
                                    </tr>
                                    <?php
                                            include 'modal_foto_home.php';
                                        }
                                    ?>
                                </tbody>
                            </table>
    ...
    <div class="modal fade" id="tambah_foto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="tambah-foto.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Judul" name="judul_foto" required="required">
                        </div>
                        <div class="form-grup">
