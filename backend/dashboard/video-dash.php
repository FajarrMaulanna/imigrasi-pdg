                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Video Homepage</h6>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><iframe width="283px" height="200px" src="https://www.youtube.com/embed/<?php echo $vid['kode_vid'];?>" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
                                        <td><?php echo $vid['judul_vid'];?></td>
                                        <td><?php echo $vid['kode_vid'];?></td>
                                        <td><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal_vid<?php echo $vid['id']?>">Update</button></td>
                                    </tr>
                                    <?php
                                            include 'modal_video_home.php';
                                        }
                                    ?>
                                </tbody>
                            </table>
