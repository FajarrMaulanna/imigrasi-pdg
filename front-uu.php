    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">Undang-Undang</h2>
                <div class="row">
                    <?php 
                        $data_uu = mysqli_query($mysqli, "SELECT * FROM undang_undang ORDER BY id DESC");
                        while($uu = mysqli_fetch_array($data_uu)){
                    ?>
                    <div class="col-lg-4">
                        <div class="modal-content" id="item_maj">
                            <div class="modal-header">
                                <a href="backend/files/undang-undang/<?php echo $uu['file_uu']; ?>" target="_blank" class="btn btn-success btn-sm">
                                    <i class="bi bi-search"></i>
                                </a>
                            </div>
                            <div class="modal-body" id="body_u">
                                <a href="backend/files/undang-undang/<?php echo $uu['file_uu']; ?>" target="_blank" style="text-decoration: none;"><p id="link_maj"><?php echo $uu['judul_uu'];?></p></a>
                            </div>
