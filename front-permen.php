    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">Peraturan Mentri</h2>
                <div class="row">
                    <?php 
                        $data_permen = mysqli_query($mysqli, "SELECT * FROM per_men ORDER BY id DESC");
                        while($permen = mysqli_fetch_array($data_permen)){
                    ?>
                    <div class="col-lg-4">
                        <div class="modal-content" id="item_maj">
                            <div class="modal-header">
                                <a href="backend/files/peraturan_mentri/<?php echo $permen['file_permen']; ?>" target="_blank" class="btn btn-success btn-sm">
                                    <i class="bi bi-search"></i>
                                </a>
                            </div>
                            <div class="modal-body" id="body_u">
                                <a href="backend/files/peraturan_mentri/<?php echo $permen['file_permen']; ?>" target="_blank" style="text-decoration: none;"><p id="link_maj"><?php echo $permen['judul_permen'];?></p></a>
                            </div>
