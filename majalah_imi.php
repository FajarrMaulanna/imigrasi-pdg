...
<head>
    ...
    <title>Majalah || Imigrasi Padang</title>
    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">MAJALAH IMIGRASI RANCAK</h2>
                <hr>
                <div class="row">
                    <?php 
                        $data_maj = mysqli_query($mysqli, "SELECT * FROM majalah_imi ORDER BY id_maj DESC");
                        while($maj = mysqli_fetch_array($data_maj)){
                    ?>
                    <div class="col-lg-4 col-sm-2">
                        <div class="modal-content" id="item_maj">
                            <div class="modal-body">
                                <a href="backend/files/majalah/<?php echo $maj['file_maj']; ?>" target="_blank" style="text-decoration: none;"><p id="link_maj"><?php echo $maj['nama_maj'];?></p></a>
                                <a href="backend/files/majalah/<?php echo $maj['file_maj']; ?>" target="_blank" style="text-decoration: none;"><p id="link_maj"><img src="backend/files/cover_majalah/<?php echo $maj['cover_maj']; ?>" alt="" class="cover"></a>
                            </div>
                        </div>
                    </div>
                    <?php 
