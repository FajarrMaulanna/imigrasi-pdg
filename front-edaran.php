    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">Surat Edaran</h2>
                <div class="row">
                    <?php 
                        $data_sur = mysqli_query($mysqli, "SELECT * FROM sur_edaran ORDER BY id DESC");
                        while($sur = mysqli_fetch_array($data_sur)){
                    ?>
                    <div class="col-lg-4">
                        <div class="modal-content" id="item_maj">
                            <div class="modal-header">
                                <a href="backend/files/surat_edaran/<?php echo $sur['file_edaran']; ?>" target="_blank" class="btn btn-success btn-sm">
                                    <i class="bi bi-search"></i>
                                </a>
                            </div>
                            <div class="modal-body" id="body_u">
                                <a href="backend/files/surat_edaran/<?php echo $sur['file_edaran']; ?>" target="_blank" style="text-decoration: none;"><p id="link_maj"><?php echo $sur['judul_edaran'];?></p></a>
                            </div>
