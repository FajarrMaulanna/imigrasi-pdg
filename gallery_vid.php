...
<head>
    ...
    <title>Gallery Video || Imigrasi Padang</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                            INFO PUBLIK
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php 
    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">GALLERY VIDEO</h2>
                <hr>
                <div class="row">
                    <?php 
                    ...
                    ?>
                    <div class="col-lg-3">
                        <iframe id="vid_items" width="250px" height="170px" src="https://www.youtube.com/embed/<?php echo $vid['kode_vid'];?>" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <?php 
                        }
                    ?>
