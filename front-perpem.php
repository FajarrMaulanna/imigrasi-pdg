    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">Peraturan Pemerintah</h2>
                <div class="row">
                    <?php 
                        $data_perpe = mysqli_query($mysqli, "SELECT * FROM per_pemerintah ORDER BY id DESC");
                        while($perpe = mysqli_fetch_array($data_perpe)){
                    ?>
                    <div class="col-lg-4">
                        <div class="modal-content" id="item_maj">
                            <div class="modal-header">
                                <a href="backend/files/peraturan_pemerintah/<?php echo $perpe['file_perpem']; ?>" target="_blank" class="btn btn-success btn-sm">
                                    <i class="bi bi-search"></i>
                                </a>
                            </div>
                            <div class="modal-body" id="body_u">
                                <a href="backend/files/peraturan_pemerintah/<?php echo $perpe['file_perpem']; ?>" target="_blank" style="text-decoration: none;"><p id="link_maj"><?php echo $perpe['judul_perpem'];?></p></a>
                            </div>
