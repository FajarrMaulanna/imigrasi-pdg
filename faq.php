...
<head>
    ...
    <title>FAQ || Imigrasi Padang</title>
    ...
    <!-- CONTENT -->
        <div class="jumbotron-fluid">
            <div class="container" id="content_vid">
                <h2 class="header_vid">FAQ</h2>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="modal-content" id="faq-space">
                            <div class="modal-body">
                                <ol>
                                    ...
                                    ?>
                                    <li>
                                        <p><b><?php echo $faq['pertanyaan']; ?></b></p>
                                        <p><i><?php echo $faq['jawaban']; ?></i></p>
                                    </li>
                                    <?php 
                                        }
                                    ?>
